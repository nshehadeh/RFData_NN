function [out,ax,l,outside] = scan_convert(iin,shape,min_phi,span_phi,apex,dsfactor,freq,varargin)
%
% SCAN_CONVERT
%
...
% [out,ax,la,outside]=scan_convert(in,shape,min_phi,span_phi,apex,interp)
%
% User Defined Coordinates ans Spacing
% [out,ax,la,outside]=scan_convert(in,shape,min_phi,span_phi,apex,interp,[ax_min ax_max ax_inc lat_min lat_max lat_inc]);
% 
% Type this...
...
[idx,i00,dr,dth,l,ax]=scmap(size(iin),'sector',min_phi,span_phi,apex,dsfactor,freq,q);
